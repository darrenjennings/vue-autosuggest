...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(exports, require("../src/parts/DefaultSection.js"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.DefaultSection);
    global.UrlSection = mod.exports;
  }
  ...
  exports.default = {
    name: "url-section",
    extends: _DefaultSection2.default,
    methods: {
  ...
  var DefaultSection = {
    ...
    render: function render(h) {
      ...
      return h("ul", {
        ...
        }, [_this.renderSuggestion ? _this.renderSuggestion(item) : _this.$scopedSlots.default && _this.$scopedSlots.default({
          key: key,
          suggestion: item
        })]);
      })]);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(57)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(exports, require("../src/Autosuggest.vue"));
  } else {
    var mod = {
      exports: {}
    };
  ...
  exports.default = {
    ...
    methods: {
      onInputChange: function onInputChange(text) {
        ...
        var suggestionsData = this.options[0].data.filter(function (item) {
          return item.toLowerCase().indexOf(text.toLowerCase()) > -1;
        });
        var blogData = this.options[1].data.filter(function (item) {
          return item.value.toLowerCase().indexOf(text.toLowerCase()) > -1;
        });

        suggestionsData.length > 0 && filtered.push({
          label: "Suggestions",
          data: suggestionsData
        });

        blogData.length > 0 && filtered.push({
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(58), __webpack_require__(68), __webpack_require__(31), __webpack_require__(92)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(exports, require("babel-runtime/helpers/extends"), require("babel-runtime/helpers/typeof"), require("./parts/DefaultSection.js"), require("./utils"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global._extends, global._typeof, global.DefaultSection, global.utils);
    global.Autosuggest = mod.exports;
  }
})(this, function (exports, _extends2, _typeof2, _DefaultSection, _utils) {
  "use strict";
  ...
  exports.default = {
    ...
    props: {
      ...
      getSuggestionValue: {
        ...
        default: function _default(suggestion) {
          ...
          if ((typeof item === "undefined" ? "undefined" : (0, _typeof3.default)(item)) === "object" && item.hasOwnProperty("name")) {
            return item.name;
          } else {
            return item;
          }
      ...
      listeners: function listeners() {
        ...
        return (0, _extends3.default)({}, this.$listeners, {
          focus: function focus(e) {
            _this.$listeners.focus && _this.$listeners.focus(e);
            if (_this.inputProps.onFocus) {
              _this.onFocus(e);
            }
          },
          blur: function blur(e) {
            _this.$listeners.blur && _this.$listeners.blur(e);
            if (_this.inputProps.onBlur) {
              _this.onBlur(e);
            }
          },
          click: function click() {
            ...
            if (_this.inputProps.onClick) {
              _this.onClick(_this.currentItem);
            }
    ...
    methods: {
      ...
      ensureItemVisible: function ensureItemVisible(item, index) {
        var resultsScrollElement = this.$el.querySelector("." + this.componentAttrClassAutosuggestResults);

        if (!item || !index && index !== 0 || !resultsScrollElement) {
          return;
        }

        var itemElement = this.$el.querySelector("#autosuggest__results_item-" + index);
        if (!itemElement) {
          return;
        }
      ...
      clickedOnScrollbar: function clickedOnScrollbar(mouseX) {
        var results = this.$el.querySelector("." + this.componentAttrClassAutosuggestResults);
      ...
      setCurrentIndex: function setCurrentIndex(newIndex) {
        ...
        var element = this.$el.querySelector("#autosuggest__results_item-" + this.currentIndex);

        var hoverClass = "autosuggest__results_item-highlighted";
        if (this.$el.querySelector("." + hoverClass)) {
          (0, _utils.removeClass)(this.$el.querySelector("." + hoverClass), hoverClass);
        }
        if (element) {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(45), __webpack_require__(49), __webpack_require__(51)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports !== "undefined") {
        factory(require('vue'), require('./UrlSection.vue'), require('./App.vue'));
    } else {
        var mod = {
            exports: {}
        };
        factory(global.vue, global.UrlSection, global.App);
        global.index = mod.exports;
    }
})(this, function (_vue, _UrlSection, _App) {
    'use strict';

    var _vue2 = _interopRequireDefault(_vue);

    var _UrlSection2 = _interopRequireDefault(_UrlSection);
    ...
    _vue2.default.component('UrlSection', _UrlSection2.default);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(29), __webpack_require__(46).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(29), __webpack_require__(48)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_UrlSection_vue__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_UrlSection_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_UrlSection_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_UrlSection_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_UrlSection_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_54f0eb59_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_UrlSection_vue__ = __webpack_require__(50);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_UrlSection_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_54f0eb59_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_UrlSection_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_54f0eb59_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_UrlSection_vue__["b" /* staticRenderFns */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7a20c22c_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(15);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7a20c22c_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7a20c22c_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var update = add("5938a22d", content, true, {});
...
// module
exports.push([module.i, "body{max-width:800px;padding:20px;margin-left:auto!important;margin-right:auto!important;font-family:monospace;background-color:#f2f2f2}#autosuggest__input{outline:none;position:relative;display:block;font-family:monospace;font-size:20px;border:1px solid #616161;border-bottom-left-radius:3px;border-bottom-right-radius:3px;padding:10px;width:100%;box-sizing:border-box;-webkit-box-sizing:border-box;-moz-box-sizing:border-box}#autosuggest__input.autosuggest__input-open{border-bottom-left-radius:0;border-bottom-right-radius:0}.autosuggest__results-container{position:relative;width:100%}.autosuggest__results{font-weight:300;margin:0;position:absolute;z-index:10000001;width:100%;border:1px solid #e0e0e0;border-bottom-left-radius:4px;border-bottom-right-radius:4px;background:#fff;padding:0}.autosuggest__results ul{list-style:none;padding-left:0;margin:0}.autosuggest__results .autosuggest__results_item{cursor:pointer;padding:15px}#autosuggest ul:first-child > .autosuggest__results_title{border-top:none}.autosuggest__results .autosuggest__results_title{color:gray;font-size:11px;margin-left:0;padding:15px 13px 5px;border-top:1px solid #d3d3d3}.autosuggest__results .autosuggest__results_item.autosuggest__results_item-highlighted,.autosuggest__results .autosuggest__results_item:active,.autosuggest__results .autosuggest__results_item:focus,.autosuggest__results .autosuggest__results_item:hover{background-color:#ddd}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3962c4be_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Autosuggest_vue__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(15);
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3962c4be_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Autosuggest_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3962c4be_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Autosuggest_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return render; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return staticRenderFns; });
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h1',[_vm._v("🔍 Vue-autosuggest")]),_vm._v(" "),_c('div',{staticStyle:{"padding-top":"10px","margin-bottom":"10px"}},[(_vm.selected)?_c('span',[_vm._v("You have selected "+_vm._s(_vm.selected))]):_vm._e()]),_vm._v(" "),_c('div',[_c('vue-autosuggest',{ref:"autocomplete",attrs:{"suggestions":_vm.filteredOptions,"input-props":_vm.inputProps,"section-configs":_vm.sectionConfigs,"getSuggestionValue":_vm.getSuggestionValue},on:{"focus":_vm.focusMe},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var suggestion = ref.suggestion;
return [(suggestion.name === 'blog')?_c('div',[_c('a',{attrs:{"target":"_blank","href":suggestion.item.url}},[_vm._v(_vm._s(suggestion.item.value))])]):_c('div',[_vm._v(_vm._s(suggestion.item))])]}}])})],1)])}
var staticRenderFns = []
